...
urlpatterns = [
	...
	url(r'^home$', rent_views.home, name='home'),
    ...
    url(r'^item_photo_r/(?P<id>\S+)$', rent_views.get_item_photo_r, name="get_item_photo_r"),
    url(r'^profile/(?P<id>\d+)$', rent_views.view_profile, name="profile"),
    url(r'^profile$', rent_views.view_profile1, name="profile"),
